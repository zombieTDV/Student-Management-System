...
#         assert (
#             authed_student is not None
#             and authed_student.fullName == "Nguyễn Văn Test Kế Thừa"
#         )
...
#         assert isinstance(
#             notifications[0], Announcement
#         )  # Kiểm tra đúng loại đối tượng
...
#         reloaded_student = Account.find_by_id(authed_student._id)
#         assert (
#             hasattr(reloaded_student, "is_active")
#             and reloaded_student.is_active is False
#         )
